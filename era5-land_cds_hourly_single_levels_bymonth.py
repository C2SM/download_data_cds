...
for year in range(startyr, endyr+1):
    for month in month_list:
        ...
        os.system(f'cdo -f nc copy {grib_file} {workdir}/variables_1hr_era5-land_{year}{month}.nc')
        ...
        for v, var in enumerate(variables):
            ...
            os.system(f'ncatted -a units,{old_names[v]},c,c,"{units}" {workdir}/{old_names[v]}_1hr_era5-land_{year}{month}_ncatted.nc {workdir}/{old_names[v]}_1hr_era5-land_{year}{month}_ncatted2.nc')
