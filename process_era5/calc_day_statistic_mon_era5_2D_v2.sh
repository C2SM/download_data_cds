...
logfile="calc_day_statistic_mon_era5_2D_v2_$date.log"
{
##-----------------------##
...
do
    ...
    do
        ...
        do
            ...
            # convert ncdf3 to ncdf4
            nccopy -k 4 ${archive}/original/${VARI}/1hr/${YEAR}/${VARI}_1hr_${data}_${YEAR}${MONTH}.nc ${name_in1}
            ...
            if [[ ${product_type} = "forecast" ]]; then
                ...
                nccopy -k 4 ${name_in2} ${workdir}/${VARI}_1hr_${data}_${YEAR2}${MONTH2}_nc4.nc
                cdo seltimestep,1,1 ${workdir}/${VARI}_1hr_${data}_${YEAR2}${MONTH2}_nc4.nc ${workdir}/${VARI}_1hr_${data}_${YEAR2}${MONTH2}_1.nc
            ...
            if [ ${agg_method} = "mean" ]; then
                ...
                if [[ ${variable_in} = "ssrd"  ||  ${variable_in} = "strd"  ||  ${variable_in} = "str" ]]; then
                    cdo divc,1440  ${name_day_work}.nc ${name_day_work}_divc.nc
