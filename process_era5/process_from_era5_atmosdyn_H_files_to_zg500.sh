...
logfile="process_from_era5_atmosdyn_H_files_to_zg500_$date.log"
{
##-----------------------##
    ...
    do
        ...
        do
            ...
            do
                ...
                ncks -O -v ${variable_in} ${FILE} ${workdir}/${new_filename}.nc
                new_filename2=$(echo "$new_filename" | tr Z G)
                echo $new_filename2
                cdo sellevel,50000 ${workdir}/${new_filename}.nc ${workdir}/${new_filename2}.nc
                ...
                const=9.80665
                cdo divc,${const} ${workdir}/${new_filename2}.nc ${workdir}/${new_filename2}_divc.nc
                rm ${workdir}/${new_filename2}.nc
                ncatted -a units,${variable_in},m,c,"m" ${workdir}/${new_filename2}_divc.nc ${workdir}/${new_filename2}.nc
            done
            # concatenate all files for one day
            ncrcat ${workdir}/G${YEAR}${MONTH}${DAY}*.nc ${workdir}/Z500${YEAR}${MONTH}${DAY}.nc
            ...
            rm ${workdir}/G${YEAR}${MONTH}${DAY}*.nc

            # change variable name to cmip name
            cdo chname,${variable_in},${variable_out} ${workdir}/${variable_in}500_day_${YEAR}${MONTH}${DAY}.nc ${workdir}/${variable_out}_day_${YEAR}${MONTH}${DAY}.nc
